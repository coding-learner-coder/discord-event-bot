...
if not TOKEN:
    raise SystemExit("DISCORD_TOKEN not set. Create a .env file or set the environment variable.")

intents = discord.Intents.default()
if os.environ.get("ENABLE_MESSAGE_CONTENT", "false").lower() in ("1", "true", "yes"):
